...
(function ($) {
  ...
  /**expolre map slider */
  $(".exploer-ttraction-slider").owlCarousel({
    loop: true,
    margin: 24,
    nav: true,
    dots: false,
    ...
    navText: [
        ...
        '<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M9 6L15 12L9 18" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/></svg>'
    ],
    responsive: {
        0: { // Mobile (0px - 575px)
            items: 1,
        ...
        576: { // Small devices (576px and up)
            items: 1,
            slideBy: 1,
        },
        ...
        1200: { // Large screens (1200px and up)
            items: 2,
            slideBy: 2,
        }
    }
